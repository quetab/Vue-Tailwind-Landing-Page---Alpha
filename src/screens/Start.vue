    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form @submit.prevent="handleSubmit">
                ...
                <!-- Password confirmation if register-->
                <Transition name="slide-fade">
                    <div v-if="registering" class="mb-6">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                            Confirm Password
                        </label>
                        <input
                ...
                <!-- End Password confirmation if register-->
...
export default {
    ...
    methods: {
        handleLogin() {
            ...
            this.axios.post(`${this.baseUrl}/login`, formData, {
                headers: headers
            })
            .then(response => {
    ...
    mounted(){
        this.baseUrl = import.meta.env.VITE_API_BASEURL;
    }
};
</script>
